...
FEDORA_SOURCES := https://src.fedoraproject.org/rpms/alsa-utils/raw/f$(subst fc,,$(DIST))/f/sources
SRC_FILES := \
...
SRC_URLS := $(addprefix https://www.alsa-project.org/files/pub/utils/,$(SRC_FILES))
